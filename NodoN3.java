...
public class NodoN3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            hilo = new Thread(new NodoN3.handlerNode(previousNode));
            hilo.start();
        }
    }
    ...
    public static class handlerNode implements Runnable {
        ...
        public handlerNode(Socket s) {
            ...
            try {
                ...
                Logger.getLogger(NodoN3.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    Socket[] socketNodos = {SocketNodo1, SocketNodo2, SocketNodo4};
                    DataOutputStream[] salidaNodos = {salidaNodo1, salidaNodo2, salidaNodo4};
